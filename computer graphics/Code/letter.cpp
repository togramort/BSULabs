...
void letter::getIndexArray()
{
    ...
    setQuad(8, 10, 11, 7, 6);
    setQuad(9, 8, 11, 7, 4);
    setQuad(10, 8, 9, 10, 11);

    setQuad(11, 12, 13, 14, 15);
    setQuad(12, 12, 13, 17, 16);
    setQuad(13, 13, 14, 18, 17);
    setQuad(14, 16, 17, 18, 19);
    setQuad(15, 15, 14, 18, 19);
    setQuad(16, 12, 15, 19, 16);
}
